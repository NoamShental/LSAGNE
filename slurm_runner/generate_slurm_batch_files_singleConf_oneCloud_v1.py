...
def create_run_options(prefix: str, path: str, CV_TISSUE:str , CV_DRUG:str) -> pd.DataFrame:
    options = []
    #single option
    options.append({                                          #############
        'n_epochs': 3000,                                     # 
        ...
        'embedding_dim': 20,
        'loss_coef':{
            'clouds_classifier': 2000,
            'tissues_classifier': 2000,
            'distance_from_cloud_center_6h': 5000,
            'distance_from_cloud_center_24h': 1000,
            'vae_kld': 0.01,
            ...
            'treatment_vectors_different_directions': 1000,
            'drug_and_treatment_vectors_different_directions': 1000,
            'treatment_and_drug_vectors_distance_p1_p2_loss': 2000,
            'treatment_and_drug_vectors_distance_p1_p2_to_treated_loss': 2000
        },
        'warmup_reference_points_loss_coef': {
            'clouds_classifier': 2000,
            'tissues_classifier': 2000,
            'distance_from_cloud_center_6h': 0,
            'distance_from_cloud_center_24h': 0,
            'vae_kld': 0.01,
            ...
            'treatment_vectors_different_directions': 0,
            'drug_and_treatment_vectors_different_directions': 0,
        ...
        'clouds_trimming_epochs':[310],
        'cross_validation_clouds': [CV_TISSUE,CV_DRUG],
        'treatment_and_drug_vectors_distance_loss_cdist_usage':True
    })
...
def main():
    ...
    """
    version = '0.9.1'
    HOME_PATH = '/RG/compbio/michaelel/lsagne_v0.9.0/lsagne/'
    CODE_PATH = '/RG/compbio/michaelel/lsagne_v0.9.0/lsagne'
    ...
    CLOUDS_PATH = os.path.join(HOME_PATH, 'slurm_runner/unique_clouds_full_8x8.csv')
    ...
    for unique_clouds_i, unique_cloud in unique_clouds_df.iterrows():
        ...
        test_options = create_run_options(test_name, PYTHON_OUTPUT_FOLDER,non_tumor_code,pert)
